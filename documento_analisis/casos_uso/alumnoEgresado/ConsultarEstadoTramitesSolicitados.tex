\begin{UseCase}{CUEE03}{Consultar estatus de los tramites solicitados}{El alumno o egresado podrá consultar el estado en el que se encuantra cada documento que haya solicitado.}
	\UCitem{Versión}{1.0}
