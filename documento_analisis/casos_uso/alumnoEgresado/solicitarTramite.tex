...
\begin{UseCase}{CUEE02}{Solicitar trámite}{Un alumno o egresado requiere hacer una petición de trámite a control escolar}
  ...
  \UCitem{Propósito}{El paciente evita ir físicamente a las oficinas de control escolar y tiene la posibilidad de pedir el tipo de documento deseado via internet.}
  \UCitem{Entradas}{
    \begin{itemize}
