\pagebreak
\begin{UseCase}{CUA03.1}{Aceptar o rechazar solicitudes}{El analista 
...
le va a realizar el documento.}
  \UCitem{Entradas}{
    \begin{itemize}
		\item Botón de descisión: Arreglo de botones con los siguientes textos: Aceptar, Rechazar. 
    \end{itemize}
  }
  \UCitem{Salidas}{
    \begin{itemize}
...
solicitado algún trámite.
  ...
  \UCitem{Observaciones}{
		\begin{itemize}
			\item El analista en dado de que se equivoque podrá cambiar de aceptar a rechazar o viceversa en la opcion que se encuentra del lado izquierdo en el menu.
			\end{itemize}
  }
  \UCitem{Errores}{
  	\begin{itemize}
