\begin{UseCase}{CUG02}{Iniciar sesión empleado}{Método para autentificar un usuario ante el sistema.}
  ...
  \UCitem{Entradas}{
    \begin{itemize}
      ...
      \item RFC: cadena compuesta por la primer letra de su apellido paterno así como la primer vocal del mismo, la tercer letra es la inicial de su apellido materno seguida de la primer letra de su nombre, ``YY/MM/DD'', donde YY, MM, DD, son número enteros que representan el año,día y mes de nacimiento de la persona, finalizando con la homoclave establecida por el sistema de RFC.
    \end{itemize}
  }
  \UCitem{Origen}{
    \begin{itemize}
